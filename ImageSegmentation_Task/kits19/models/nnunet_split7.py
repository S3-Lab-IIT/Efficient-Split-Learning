...
def get_full_model():
    print("BOTTLENECK MODEL: all upsamping client side")
    model = Baseline()
    return model
...
class back(nn.Module):
    def __init__(self,pretrained=False,skips=[]):
        ...
        self.back_tu = full_model.tu
        self.back_localizations = full_model.conv_blocks_localization
        self.skips = skips
