...
class center_back(nn.Module):
    def __init__(self,pretrained=False,skips=[]):
        ...
        self.center_tu = full_model.tu[:2] 
        self.center_localizations = full_model.conv_blocks_localization[:2] 
...
class back(nn.Module):
    def __init__(self,pretrained=False,skips=[]):
        ...
        self.back_tu = full_model.tu[2:] 
        self.back_localizations = full_model.conv_blocks_localization[2:] 
        self.skips = skips
...
if __name__ == '__main__':
    ...
    cf_params = sum([p.numel() for p in cf.parameters()])
