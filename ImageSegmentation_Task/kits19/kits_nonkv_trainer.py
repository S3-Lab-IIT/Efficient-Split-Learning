...
class PfslKits:
    ...
    def init_clients_with_data(self,):
        ...
        for idx, (c_id, client) in enumerate(self.clients.items()):
            ...
            train_ds, test_ds = self.kits.get_datasets(client_id=idx, pool=self.pooling_mode)
    ...
    def init_client_models_optims(self, input_channels=1):
        ...
        and optimizer for each split: Adam / AdamW / SGD
        """
    ...
    def _create_save_dir(self,):
        self.save_dir = Path(f'./saved_models/{self.args.dataset}/normal_mode')
